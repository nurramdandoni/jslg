    ...
    <body  class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading"  >
        ...
        <div class="kt-grid kt-grid--hor kt-grid--root">
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
                ...
                2019&nbsp;&copy;&nbsp;<a href="#" target="_blank" class="kt-link">PT Gravitasi Teknologi Indonesia</a>
                </div>
                <div class="kt-footer__menu">
                <a href="http://localhost/jslg/demo1_classic_fix/" target="_blank" class="kt-footer__menu-link kt-link">About</a>
                <a href="http://localhost/jslg/demo1_classic_fix/" target="_blank" class="kt-footer__menu-link kt-link">Team</a>
                <a href="http://localhost/jslg/demo1_classic_fix/" target="_blank" class="kt-footer__menu-link kt-link">Contact</a>
                </div>
                </div>
                </div>
                <!-- end:: Footer -->			</div>
